...
var from = new Vue({
	...
	var mm = ('0' + (date.getMonth() + 1)).slice(-2);
         ...
         var result = this.make_form_paper1(this.baseUrl,yyyy,mm,dd);
	...
	//1,2はチャンネルの事
     ...
     methods:{
       ...
       make_form_paper1:function (baseUrl,year,month,day) {
           console.log("make_form_paper1");
           return $.ajax({
               url: baseUrl+'/day?mode=t&year=' + year + "&month=" + month + "&day="+ day + "&rid=" + this.regionId,
               type:'post',
               dataType:'json',
               async:false,
           })
