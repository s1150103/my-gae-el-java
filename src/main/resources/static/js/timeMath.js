/**
 * Created by innocent on 4/21/17.
 */
var timeMath = {
    // 加算
    sum : function() {
    ...
    divnum : function (time,num) {
        ...
        console.log("divnum:",time,second,result,this.toTimeFormat(result));
        return this.toTimeFormat(Math.round(result));
    ...
    toTimeFormat : function(fullSecond) {
        ...
        return ((fullSecond < 0) ? '-' : '') + ("0"+hour).slice(-2) + ':' + minute + ':' + second;
    }
};